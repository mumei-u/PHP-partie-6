...
<html lang="fr" dir="ltr">
    ...
    <body>
        <div class="container text-center bg-secondary">
            <h1 class="text-center text-dark">PHP | P6-ex3</h1>
            <nav>
            ...
            <h5 class="text-white">Faire une page index.php. Tester sur cette page que tous les paramètres de cette URL existent et les afficher: index.php?startDate=2/05/2016&endDate=27/11/2016</h5>
        </div>
        <div class="container text-center">
            <p><?php echo $_GET['startDate'] . ' ' . $_GET['endDate']; ?></p>
