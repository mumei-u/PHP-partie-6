...
<html lang="fr" dir="ltr">
    ...
    <body>
        <div class="container text-center bg-secondary">
            <h1 class="text-center text-dark">PHP | P6-ex2</h1>
            <nav>
            ...
            <h5 class="text-white">Faire une page index.php. Tester sur cette page que le paramètre age existe et si c'est le cas l'afficher sinon le signaler : index.php?lastname=Nemare&firstname=Jean</h5>
        </div>
        <div class="container text-center">
            <?php
            if (!isset($_GET['age'])) {
                $result = 'le paramètre n\'existe pas';
            }
            var_dump($_GET)
            ?>
            <p><?= $result ?></p>
