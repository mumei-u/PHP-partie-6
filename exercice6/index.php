...
<body>
  <div class="container text-center bg-secondary">
    <h1 class="text-center text-dark">PHP | P6-ex5</h1>
    <nav>
    ...
    <h5 class="text-white">Faire une page index.php. Tester sur cette page que tous les paramètres de cette URL existent et les afficher: index.php?building=12&room=101</h5>
  </div>
    ...
    ?>
    <p> Les paramètres sont '<?=$result?>', ce sont '<?php echo $_GET['building'].' et '.$_GET['room'];?>'</p>
    <!-- Le & dans le code a été remplacé par '&amp;' dans le lien. C'est qu'en HTML & se code '&amp;' dans le code source -->
    <a href="index.php?building=12&amp;room=101">test url</a>
