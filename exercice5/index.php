...
<html lang="fr" dir="ltr">
    ...
    <body>
        <div class="container text-center bg-secondary">
            ...
            <h5 class="text-white">Faire une page index.php. Tester sur cette page que tous les paramètres de cette URL existent et les afficher: index.php?week=12</h5>
        </div>
        <div class="container text-center">
            <p> Le paramètre est '<?= $result ?>', et il s'agit de '<?php echo $_GET['week']; ?>'</p>
            <a href="index.php?week=12">test url</a>
